...
entrance = pygame.image.load("textures/entrance_portal.png")
exit = pygame.image.load("textures/exit_portal.png")

tl = {"o": grassimage, "x": grasscenter, "l": bluegrass, "b": bluegrassMid, 'd': darkBlock,"e": entrance,"s":exit}
